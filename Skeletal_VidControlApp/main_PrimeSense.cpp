...
void XN_CALLBACK_TYPE SwipeCB_Up(XnFloat fVelocity, XnFloat fAngle, void* pUserCxt)
{
	printf("\nUP SWIPE DETECTED\n");
}

void XN_CALLBACK_TYPE SwipeCB_Right(XnFloat fVelocity, XnFloat fAngle, void* pUserCxt)
{
...
int main(int argc, char ** argv)
{
	...
	g_pSwipe->RegisterSwipeUp(NULL, &SwipeCB_Up);
	g_pSwipe->RegisterSwipeRight(NULL, &SwipeCB_Right);
